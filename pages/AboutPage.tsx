...
const AboutPage: React.FC = () => {
  const affiliations = [
    { name: 'Kukkiwon', src: 'https://www.tigerleestkd.com/wp-content/uploads/2017/06/kukkiwon-copy.jpg' },
    { name: 'Yong In University', src: 'https://www.tigerleestkd.com/wp-content/uploads/2017/06/yongin.jpg' },
    { name: 'KTA', src: 'https://www.tigerleestkd.com/wp-content/uploads/2018/04/KTA_Redlogo7.png' },
    { name: 'WTF', src: 'https://www.tigerleestkd.com/wp-content/uploads/2018/04/WTF_Logo.png' },
  ];
    ...
    <div className="pt-0 bg-white">
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start mb-24">
            ...
            >
                <img 
                    src="https://www.tigerleestkd.com/wp-content/uploads/2018/04/Master_Lee_Profile.png" 
        ...
        {/* Affiliations 1 */}
        <div className="mb-24 bg-white p-12">
             <h3 className="font-heading text-2xl font-bold text-center mb-10 text-gray-800 uppercase tracking-wider">Affiliations</h3>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
             <motion.div 
                className="lg:w-2/3 order-2 lg:order-1"
                initial={{ opacity: 0, x: -30 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
            >
                ...
                <div className="prose prose-lg text-gray-600 space-y-4">
                    ...
                    <blockquote className="border-l-4 border-brand-red pl-4 italic text-gray-800 bg-gray-50 py-2 pr-2 my-4">
            ...
            <motion.div 
                className="lg:w-1/3 order-1 lg:order-2 flex justify-center lg:justify-end"
                initial={{ opacity: 0, x: 30 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
            >
                 <img 
                    src="https://www.tigerleestkd.com/wp-content/uploads/2018/04/Lee_Family.png" 
                    alt="Lee Family" 
                    className="w-full h-auto max-w-md"
                />
            </motion.div>
