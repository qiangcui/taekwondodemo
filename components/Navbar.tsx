...
const programLinks = [
    { 
        ...
        image: 'https://www.tigerleestkd.com/wp-content/uploads/2018/05/little-tigers.jpg',
        age: 'Ages 4-5'
    },
    { 
        label: "Children's Class", 
        href: '/programs#children', 
        image: 'https://www.tigerleestkd.com/wp-content/uploads/2018/05/children.jpg',
        age: 'Ages 6-12'
    },
    { 
        label: 'Family Class', 
        href: '/programs#family', 
        image: 'https://www.tigerleestkd.com/wp-content/uploads/2018/05/family.jpg',
        age: 'All Ages'
    },
    { 
        label: 'Adult Class', 
        href: '/programs#adult', 
        image: 'https://www.tigerleestkd.com/wp-content/uploads/2018/05/adults.jpg',
        age: 'Ages 13+'
    },
];
      ...
      >
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex items-center">
             <Link to="/">
               <img 
                 src="https://www.tigerleestkd.com/wp-content/uploads/2018/05/tiger-lees-logo.png" 
                 alt="Tiger Lee's World Class Tae Kwon Do" 
          ...
          <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
            {navItems.map((item) => (
              ...
              >
                <Link
                  ...
                  className={`text-lg font-medium transition-colors hover:text-brand-red flex items-center ${
                    scrolled ? 'text-gray-800' : 'text-white shadow-sm'
                  }`}
                >
                  {item.label}
                            ...
                            <div className="col-span-2 mt-2">
                                ...
                                >
                                    ...
                                    <div 
                                        ...
                                        style={{ backgroundImage: "url('https://www.tigerleestkd.com/wp-content/uploads/2018/04/birthday-blur-cake-40183.jpg')" }}
                                    />
                                    {/* Overlay */}
            ...
            <button
              ...
              className={`flex items-center justify-center w-10 h-10 rounded-full transition-all duration-300 hover:scale-105 focus:outline-none ${
                scrolled 
            ...
            <div className="flex flex-col p-4 space-y-4">
              {navItems.map((item) => (
               ...
               <button
                  ...
                  className="w-full text-left text-gray-500 font-medium text-lg hover:text-brand-red hover:bg-gray-50 p-2 rounded-lg transition-colors flex items-center mt-4 border-t border-gray-100 pt-4"
                >
