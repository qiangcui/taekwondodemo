  ...
  const sections: AccordionItem[] = [
      ...
      content: (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <img 
                src="https://www.tigerleestkd.com/wp-content/uploads/2018/05/tenets1.png" 
      ...
      content: (
        <div className="space-y-6">
           <div className="float-right ml-6 mb-4 w-1/3">
             <img 
               src="https://www.tigerleestkd.com/wp-content/uploads/2018/05/fitness-249x300.png" 
      ...
      content: (
        <div className="flex flex-col md:flex-row gap-8">
           <div className="md:w-1/3">
             <img 
               src="https://www.tigerleestkd.com/wp-content/uploads/2018/05/focus-161x300.png" 
               alt="Improved Focus" 
      ...
      content: (
        <div className="space-y-6">
           <div className="float-right ml-6 mb-4 w-1/3 max-w-[250px]">
             <img 
               src="https://www.tigerleestkd.com/wp-content/uploads/2018/05/stress.png" 
               alt="Control Stress" 
               className="w-full h-auto rounded-lg shadow-md"
             />
           </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
            <div className="float-right ml-6 mb-4 w-1/3 max-w-[250px]">
             <img 
               src="https://www.tigerleestkd.com/wp-content/uploads/2018/05/self-defense-282x300.png" 
               alt="Self Defense" 
               className="w-full h-auto rounded-lg shadow-md"
             />
           </div>
      ...
      content: (
        <div className="space-y-6">
            <div className="float-right ml-6 mb-4 w-1/3 max-w-[200px]">
             <img 
               src="https://www.tigerleestkd.com/wp-content/uploads/2018/05/bully.png" 
               alt="Stop Bullying" 
               className="w-full h-auto rounded-lg shadow-md"
             />
           </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
           <div className="float-right ml-6 mb-4 w-1/3 max-w-[200px]">
             <img 
               src="https://www.tigerleestkd.com/wp-content/uploads/2018/05/tkd_vs_Karate-169x300.png" 
               alt="TKD vs Karate" 
               className="w-full h-auto rounded-lg shadow-md"
             />
           </div>
        ...
        content: (
            <div className="w-full">
                <audio controls className="w-full">
                    <source src="https://www.tigerleestkd.com/wp-content/uploads/2018/05/basicmovement-1.mp3" type="audio/mpeg" />
    ...
    },
    {
        ...
        content: (
            <div className="w-full">
                <audio controls className="w-full">
                    <source src="https://www.tigerleestkd.com/wp-content/uploads/2018/05/breathing_form.mp3" type="audio/mpeg" />
                    Your browser does not support the audio element.
                </audio>
            </div>
        )
