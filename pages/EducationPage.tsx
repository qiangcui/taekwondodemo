      ...
      content: (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <img
              src="/tigerleetkd/assets/images/tenets1.png"
      ...
      content: (
        <div className="space-y-6">
          <div className="float-right ml-6 mb-4 w-1/3">
            <img
              src="/tigerleetkd/assets/images/fitness-249x300.png"
      ...
      content: (
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-1/3">
            <img
              src="/tigerleetkd/assets/images/focus-161x300.png"
              alt="Improved Focus"
      ...
      content: (
        <div className="space-y-6">
          <div className="float-right ml-6 mb-4 w-1/3 max-w-[250px]">
            <img
              src="/tigerleetkd/assets/images/stress.png"
              alt="Control Stress"
              className="w-full h-auto rounded-lg shadow-md"
            />
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <div className="float-right ml-6 mb-4 w-1/3 max-w-[250px]">
            <img
              src="/tigerleetkd/assets/images/self-defense-282x300.png"
              alt="Self Defense"
              className="w-full h-auto rounded-lg shadow-md"
            />
          </div>
      ...
      content: (
        <div className="space-y-6">
          <div className="float-right ml-6 mb-4 w-1/3 max-w-[200px]">
            <img
              src="/tigerleetkd/assets/images/bully.png"
              alt="Stop Bullying"
              className="w-full h-auto rounded-lg shadow-md"
            />
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <div className="float-right ml-6 mb-4 w-1/3 max-w-[200px]">
            <img
              src="/tigerleetkd/assets/images/tkd_vs_Karate-169x300.png"
              alt="TKD vs Karate"
              className="w-full h-auto rounded-lg shadow-md"
            />
          </div>
