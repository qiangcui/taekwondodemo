...
const galleryImages = [
  "https://www.tigerleestkd.com/wp-content/uploads/2017/06/birthday3.jpg",
  "https://www.tigerleestkd.com/wp-content/uploads/2017/06/birthday2.jpg",
  "https://www.tigerleestkd.com/wp-content/uploads/2017/06/birthday1.jpg",
  "https://www.tigerleestkd.com/wp-content/uploads/2017/06/birthday5.jpg"
];
...
const BirthdayPartyPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const subject = encodeURIComponent("Birthday Party Inquiry");
    const body = encodeURIComponent(`
Birthday Party Inquiry Details:
------------------------
...
`);
    window.location.href = `mailto:tigerleeworldclass@gmail.com?subject=${subject}&body=${body}`;
  };
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            ...
            >
                 <div className="relative rounded-2xl overflow-hidden shadow-2xl transform rotate-2 hover:rotate-0 transition-all duration-500">
                    <img 
                        src="https://www.tigerleestkd.com/wp-content/uploads/2017/06/birthday4.jpg" 
        ...
        <div className="flex flex-col lg:flex-row gap-12 bg-gray-50 rounded-3xl overflow-hidden shadow-xl">
            ...
            <div className="lg:w-1/2 p-10 lg:p-16">
                 ...
                 <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button 
                        type="submit" 
                        className="w-full bg-brand-red text-white font-bold text-lg py-3 rounded-lg shadow-lg hover:bg-red-700 transition-all hover:scale-[1.02] flex items-center justify-center space-x-2 mt-4"
                    >
